...
const emit = defineEmits(["add_saved", "open_room", "remove_room"]);
</script>
  ...
  <div class="room-card">
    <div class="room-card-cover" @click.stop="emit('open_room')">
      ...
      <el-row class="icon-row" justify="end">
        <el-icon class="room-card-icon" size="1.57rem" color="#F56C6C">
          <delete-filled class="room-card-icon-inner" @click.stop="emit('remove_room')" />
        </el-icon>
        <el-icon class="room-card-icon" size="2rem" color="#F56C6C">
          <star-filled class="room-card-icon-inner" @click.stop="emit('add_saved')" />
        </el-icon>
      </el-row>
    </div>
